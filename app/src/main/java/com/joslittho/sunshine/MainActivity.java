...
public class MainActivity extends AppCompatActivity implements ForecastCallback {
    ...
    /**
     * {@link com.joslittho.sunshine.DetailFragment} callback for when an item has been selected.
     *
